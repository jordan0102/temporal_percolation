...
To compile:     g++ -O -Wall DavidsenRmvLink.cpp -o DavidsenRmvLink

To run:         ./DavidsenRmvLink [params] > net.edg 2> net.log

Example:        ./DavidsenRmvLink 7000 0.04 38926 > net.edg 2> net.log
...
int main(int argc, char* argv[]) { 
  ...
  DavidsenRmvLink(net, args, generator);
